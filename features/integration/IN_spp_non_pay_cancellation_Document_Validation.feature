Feature: To validate Evidence Of Cancellation pdf and Cancel Notice pdf for non pay cancel Scheduled Property LOB

  @fixture_scheduled_property_policy_issuance @integration
  Scenario: To validate Evidence Of Cancellation pdf for non pay cancel Scheduled Property LOB
  ...
  @fixture_scheduled_property_policy_issuance @integration
  Scenario: To validate Cancel Notice pdf for non pay cancel Scheduled Property LOB
    Given I have created a new "scheduled_property" policy
    And I fully issue the scheduled property policy
    When I cancel a policy with reasons in the "policy_cancellation_04" file
    When I close the cancellation modal
