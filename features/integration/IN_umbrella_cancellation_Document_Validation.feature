Feature: To validate Evidence Of Cancellation pdf and Cancel Notice pdf for Umbrella LOB

#  bug PAT-13323
  @fixture_umbrella_policy @integration @known_issue @wip
  Scenario: To validate Evidence Of Cancellation pdf for Umbrella LOB
  ...
  Scenario: To validate Cancel Notice pdf for Umbrella LOB
    Given I have started a new umbrella policy through the "auto_policy_coverages" modal
    And I fully issue the umbrella policy
    When I cancel a policy with reasons in the "policy_cancellation_01" file
    When I close the cancellation modal
