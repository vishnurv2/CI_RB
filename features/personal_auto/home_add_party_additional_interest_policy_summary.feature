...
Feature: Homeowners - Add Party - Additional Interest - Policy summary page

  @fixture_home_party_loss_payee @delete_when_done @PAT-8001 @TestCaseKey=PAT-T476 @regression
  Scenario:  Homeowners - Party - Additional Interest - Policy Summary Page
  ...
  @fixture_home_party_loss_payee @delete_when_done @PAT-8001 @TestCaseKey=PAT-T624 @regression
  Scenario:  Homeowners - Add Party - Additional Interest - Policy Summary Page - Add Another Role
    Given I have started a new home policy through the "auto policy coverages" modal
    And I begin issuance
    And I navigate to my quote "IN-Homeowners" using the left nav
    And I have loaded the fixture file named "auto_policy_party_loss_payee"
  ...
  @fixture_home_party_loss_payee @delete_when_done @PAT-8001 @TestCaseKey=PAT-T626 @regression
  Scenario:  Homeowners - Add Party - Additional Interest - Policy Summary Page - Add Another Role and then delete that role
    Given I have started a new home policy through the "auto policy coverages" modal
    And I begin issuance
    And I navigate to my quote "IN-Homeowners" using the left nav
    And I have loaded the fixture file named "auto_policy_party_loss_payee"
