...
Feature: All Terrain Vehicles can have optional coverages

  @fixture_auto_policy_all_terrain_vehicle @delete_when_done @indiana_auto @personal_auto @TestCaseKey=PAT-T99
  Scenario: All Terrain Vehicles Coverages Exist
  ...
  @fixture_auto_policy_all_terrain_vehicle_manual_coverage @delete_when_done @TestCaseKey=PAT-T100
  Scenario: Manual All Terrain Vehicle Coverages Can Be Added and Deleted
    Given I have started a new auto policy through the "auto policy coverages" modal
    And I add the specified other vehicle
