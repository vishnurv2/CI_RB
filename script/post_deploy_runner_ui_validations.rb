...
#
# POST_DEPLOY_RUNNER_UI_EDITS_VALIDATIONS!
#
# Description:
...
STDOUT.puts " "
STDOUT.puts "UI EDITS VALIDATION TESTING IN PROGRESS!"
STDOUT.puts " "
...
# Run Cucumber
CMD = "bundle exec parallel_cucumber -n #{opts[:threads].to_i} --verbose -- #{opts[:cuke]} -p parallel -p kb -p should_work -- #{feature_folder}"
