...
#
# POST_DEPLOY_RUNNER_INTEGRATION!
#
# Description:
...
STDOUT.puts " "
STDOUT.puts "INTEGRATION TESTING IN PROGRESS!"
STDOUT.puts " "
...
feature_folder = 'features/integration'
begin
  require 'fileutils'
...
# Run Cucumber
CMD = "bundle exec parallel_cucumber -n #{opts[:threads].to_i} --verbose -- #{opts[:cuke]} -p parallel -p kb -p no_regression -p should_work -- #{feature_folder}"
